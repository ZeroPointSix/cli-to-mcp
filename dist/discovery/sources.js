...
export class HelpSource {
    ...
    async discover(connector, _config) {
        ...
        const effectiveIncludeSubgroups = startupBudgetMs != null && startupIncludeSubgroups != null
        ...
        const maxDepth = startupBudgetMs != null && startupMaxDepth != null
            ? Math.min(fullMaxDepth, startupMaxDepth)
            : fullMaxDepth;
        this.log(`help discovery: ${connector.name} max_depth=${maxDepth}${startupMaxDepth != null && startupBudgetMs != null ? ` (startup_cap=${startupMaxDepth} full=${fullMaxDepth})` : ""}`);
