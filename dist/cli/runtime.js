...
import { discoverConnectorsParallel, mergeToolsByConnector, shouldBackgroundContinue, } from "./discovery-runner.js";
import { startBackgroundDiscovery, } from "./background-discovery.js";
export async function startRuntime(opts) {
    ...
    if (tools.length === 0) {
        ...
        if (merged.length > 0) {
            ...
            if (tools.length > 0)
                log(`falling back to ${tools.length} cached tools`);
        }
    }
    else {
